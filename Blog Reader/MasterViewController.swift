...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyDUU8TA4IC7Dwo13BNBng9yhZYD8ZZzLjE")!
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            for item in items  {
                                if let theItem = item as? [String:AnyObject] {
                                    print(theItem["published"]!)
                                    print(theItem["title"]!)
                                    print(theItem["content"]!)
                                    
                                    let newEvent = Event(context: context)
                                    
                                    // If appropriate, configure the new managed object.
                                    newEvent.timestamp = NSDate()
                                    newEvent.setValue(theItem["published"] as! String, forKey: "published")
                                    newEvent.setValue(theItem["title"] as! String, forKey: "title")
                                    newEvent.setValue(theItem["content"] as! String, forKey: "content")
